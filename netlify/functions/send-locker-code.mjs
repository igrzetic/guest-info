const EMAIL_COPY = {
  hr: {
    subject: 'Šifra spremnika za ključ — Villas Kraš',
    greeting: 'Pozdrav,',
    intro:
      'Hvala što ste naš gost. Ovo je šifra spremnika za ključ na imanju Villas Kraš:',
  ...
  en: {
    subject: 'Key locker code — Villas Kraš',
    greeting: 'Hello,',
    intro:
      'Thank you for being our guest. Here is the key locker code for the Villas Kraš property:',
  ...
  it: {
    subject: 'Codice cassetta chiavi — Villas Kraš',
    greeting: 'Ciao,',
    intro:
      'Grazie per essere nostro ospite. Ecco il codice della cassetta chiavi della proprietà Villas Kraš:',
  ...
  de: {
    subject: 'Schlüsseltresor-Code — Villas Kraš',
    greeting: 'Hallo,',
    intro:
      'Vielen Dank, dass Sie unser Gast sind. Hier ist der Schlüsseltresor-Code für die Unterkunft Villas Kraš:',
  ...
  sl: {
    subject: 'Koda predala za ključ — Villas Kraš',
    greeting: 'Pozdravljeni,',
    intro:
      'Hvala, ker ste naš gost. To je koda predala za ključ na posestvu Villas Kraš:',
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #e8dfd1;border-radius:16px;overflow:hidden;">
            <tr>
              <td style="padding:28px 28px 8px;font-size:24px;line-height:1.3;color:#2c2419;">Villas Kraš</td>
            </tr>
            <tr>
